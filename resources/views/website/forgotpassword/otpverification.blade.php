      ...
      <div class="authentication-inner">
         ...
         <div class="card">
            <div class="card-body">
               ...
               <!-- /Logo -->
               <h2 class="mb-2">OTP Verification required</h2>
               <p>To continue, complete this verification step. We've sent an OTP to the email. Please enter it below to complete verification.</p>
               <form id="" class="mb-3" action="{{route('company.Otpauthentication')}}" method="POST">
                  @csrf
                  <div class="mb-3">
                     <label for="otp" class="form-label">Enter OTP</label>
                     <input type="number" pattern="\d*" class="form-control" id="otp" name="otp" placeholder="Enter the OTP" autofocus>
