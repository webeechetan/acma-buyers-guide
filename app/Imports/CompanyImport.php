    ...
    */
    ...
    public function format_in_assoc_array($rows){
        ...
        foreach($rows as $row){
            ...
            $companies_data_format['update_date'] = $row[37];
            $companies_data_format['region'] = $row[38];
            $companies_data_format['products_manufactured'] = $row[39];
            $companies_data_format['product2'] = $row[40];
            $companies_data_format['product3'] = $row[41];
            $companies_data_format['product4'] = $row[42];
            $companies_data_format['scale'] = $row[43];
            $companies_data_format['ssi_info'] = $row[44];
            $companies_data_format['trademark'] = $row[45];
            $companies_data_format['total_capital'] = $row[46];
            $companies_data_format['net_investment_plant'] = $row[47];
            $companies_data_format['total_investment_plant'] = $row[48];
            $companies_data_format['sales_turnover'] = $row[49];
            $companies_data_format['s_turn_in'] = $row[50];
            $companies_data_format['export_turn_02_03'] = $row[51];
            $companies_data_format['exports_in_mln'] = $row[52];
            $companies_data_format['number_of_employees'] = $row[53];
            $companies_data_format['skilled'] = $row[54];
            $companies_data_format['semi_skilled'] = $row[55];
            $companies_data_format['un_skilled'] = $row[56];
            $companies_data_format['contractual'] = $row[57];
            $companies_data_format['management_above'] = $row[58];
            $companies_data_format['net_excise_duty_paid'] = $row[59];
            $companies_data_format['total_custom_duty_paid'] = $row[60];
            $companies_data_format['list_of_product_exported1'] = $row[61];
            $companies_data_format['list_of_product_exported2'] = $row[62];
            $companies_data_format['per_share_export_buy'] = $row[63];
            $companies_data_format['per_share_export_oem'] = $row[64];
            $companies_data_format['per_share_export_tier1'] = $row[65];
            $companies_data_format['per_share_export_afm'] = $row[66];
            $companies_data_format['per_share_domestic_oem'] = $row[67];
            $companies_data_format['per_share_domestic_tier1'] = $row[68];
            $companies_data_format['per_share_domestic_afm'] = $row[69];
            $companies_data_format['product_patent'] = $row[70];
            $companies_data_format['share_spent_on_rnd'] = $row[71];
            $companies_data_format['dsir'] = $row[72];
            $companies_data_format['expen_rd'] = $row[73];
            $companies_data_format['employee_rd'] = $row[74];
            $companies_data_format['person_name'] = $row[75];
            $companies_data_format['person_designation'] = $row[76];
            $companies_data_format['person_email'] = $row[77];
            $companies_data_format['advertisement'] = $row[78];
            $companies_data_format['field1'] = $row[79];
            $companies_data_format['field2'] = $row[80];
            $companies_data_format['other_mark1'] = $row[81];
            $companies_data_format['other_mark2'] = $row[82];
            $companies_data_format['domesticoe'] = $row[83];
            $companies_data_format['domesticoe1'] = $row[84];
            $companies_data_format['domesticoe2'] = $row[85];
            $companies_data_format['domesticoe3'] = $row[86];
            $companies_data_format['domesticoe4'] = $row[87];
            $companies_data_format['domestic_tier_oe'] = $row[88];
            $companies_data_format['domestic_tier_oe1'] = $row[89];
            $companies_data_format['domestic_tier_oe2'] = $row[90];
            $companies_data_format['domestic_tier_oe3'] = $row[91];
            $companies_data_format['cusint1'] = $row[92];
            $companies_data_format['cusint2'] = $row[93];
            $companies_data_format['cusint3'] = $row[94];
            $companies_data_format['cusint_tier1'] = $row[95];
            $companies_data_format['cusint_tier2'] = $row[96];
            $companies_data_format['cusint_tier3'] = $row[97];
            $companies_data_format['afmkt1'] = $row[98];
            $companies_data_format['afmkt2'] = $row[99];
            $companies_data_format['afmkt3'] = $row[100];
            $companies_data_format['f_collab1'] = $row[101];
            $companies_data_format['f_prod1'] = $row[102];
            $companies_data_format['nature1'] = $row[103];
            $companies_data_format['per1'] = $row[104];
            $companies_data_format['f_collab2'] = $row[105];
            $companies_data_format['f_prod2'] = $row[106];
            $companies_data_format['nature2'] = $row[107];
            $companies_data_format['per2'] = $row[108];
            $companies_data_format['f_collab3'] = $row[109];
            $companies_data_format['f_prod3'] = $row[110];
            $companies_data_format['nature3'] = $row[111];
            $companies_data_format['per3'] = $row[112];
            $companies_data_format['f_collab4'] = $row[113];
            $companies_data_format['f_prod4'] = $row[114];
            $companies_data_format['nature4'] = $row[115];
            $companies_data_format['per4'] = $row[116];
            $companies_data_format['f_collab5'] = $row[117];
            $companies_data_format['f_prod5'] = $row[118];
            $companies_data_format['nature5'] = $row[119];
            $companies_data_format['per5'] = $row[120];
            $companies_data_format['f_collab6'] = $row[121];
            $companies_data_format['f_prod6'] = $row[122];
            $companies_data_format['nature6'] = $row[123];
            $companies_data_format['per6'] = $row[124];
            $companies_data_format['f_collab7'] = $row[125];
            $companies_data_format['f_prod7'] = $row[126];
            $companies_data_format['nature7'] = $row[127];
            $companies_data_format['per7'] = $row[128];
            $companies_data_format['f_collab8'] = $row[129];
            $companies_data_format['f_prod8'] = $row[130];
            $companies_data_format['nature8'] = $row[131];
            $companies_data_format['per8'] = $row[132];
            $companies_data_format['f_collab9'] = $row[133];
            $companies_data_format['f_prod9'] = $row[134];
            $companies_data_format['nature9'] = $row[135];
            $companies_data_format['per9'] = $row[136];
            $companies_data_format['f_collab10'] = $row[137];
            $companies_data_format['f_prod10'] = $row[138];
            $companies_data_format['nature10'] = $row[139];
            $companies_data_format['per10'] = $row[140];
            $companies_data_format['member'] = $row[141];
            $companies_data_format['iso'] = $row[142];
            $companies_data_format['isodate'] = $row[143];
            $companies_data_format['isoagency'] = $row[144];
            $companies_data_format['qs'] = $row[145];
            $companies_data_format['qsdate'] = $row[146];
            $companies_data_format['qsagency'] = $row[147];
            $companies_data_format['iso14'] = $row[148];
            $companies_data_format['iso14date'] = $row[149];
            $companies_data_format['iso14agency'] = $row[150];
            $companies_data_format['ts'] = $row[151];
            $companies_data_format['tsdate'] = $row[152];
            $companies_data_format['tsagency'] = $row[153];
            $companies_data_format['deming_award'] = $row[154];
            $companies_data_format['japan_quality_medal'] = $row[155];
            $companies_data_format['emark'] = $row[156];
            $companies_data_format['bismark'] = $row[157];
