    ...
    */
    ...
    public function format_in_assoc_array($rows){
        ...
        foreach($rows as $row){
            ...
            $companies_data_format['other_mark1'] = $row[59];
            $companies_data_format['other_mark2'] = $row[60];
            $companies_data_format['domesticoe'] = $row[61];
            $companies_data_format['domesticoe1'] = $row[62];
            $companies_data_format['domesticoe2'] = $row[63];
            $companies_data_format['domesticoe3'] = $row[64];
            $companies_data_format['domesticoe4'] = $row[65];
            $companies_data_format['domestic_tier_oe'] = $row[66];
            $companies_data_format['domestic_tier_oe1'] = $row[67];
            $companies_data_format['domestic_tier_oe2'] = $row[68];
            $companies_data_format['domestic_tier_oe3'] = $row[69];
            $companies_data_format['cusint1'] = $row[70];
            $companies_data_format['cusint2'] = $row[71];
            $companies_data_format['cusint3'] = $row[72];
            $companies_data_format['cusint_tier1'] = $row[73];
            $companies_data_format['cusint_tier2'] = $row[74];
            $companies_data_format['cusint_tier3'] = $row[75];
            $companies_data_format['afmkt1'] = $row[76];
            $companies_data_format['afmkt2'] = $row[77];
            $companies_data_format['afmkt3'] = $row[78];
            $companies_data_format['f_collab1'] = $row[79];
            $companies_data_format['f_prod1'] = $row[80];
            $companies_data_format['nature1'] = $row[81];
            $companies_data_format['per1'] = $row[82];
            $companies_data_format['f_collab2'] = $row[83];
            $companies_data_format['f_prod2'] = $row[84];
            $companies_data_format['nature2'] = $row[85];
            $companies_data_format['per2'] = $row[86];
            $companies_data_format['f_collab3'] = $row[87];
            $companies_data_format['f_prod3'] = $row[88];
            $companies_data_format['nature3'] = $row[89];
            $companies_data_format['per3'] = $row[90];
            $companies_data_format['f_collab4'] = $row[91];
            $companies_data_format['f_prod4'] = $row[92];
            $companies_data_format['nature4'] = $row[93];
            $companies_data_format['per4'] = $row[94];
            $companies_data_format['f_collab5'] = $row[95];
            $companies_data_format['f_prod5'] = $row[96];
            $companies_data_format['nature5'] = $row[97];
            $companies_data_format['per5'] = $row[98];
            $companies_data_format['f_collab6'] = $row[99];
            $companies_data_format['f_prod6'] = $row[100];
            $companies_data_format['nature6'] = $row[101];
            $companies_data_format['per6'] = $row[102];
            $companies_data_format['f_collab7'] = $row[103];
            $companies_data_format['f_prod7'] = $row[104];
            $companies_data_format['nature7'] = $row[105];
            $companies_data_format['per7'] = $row[106];
            $companies_data_format['f_collab8'] = $row[107];
            $companies_data_format['f_prod8'] = $row[108];
            $companies_data_format['nature8'] = $row[109];
            $companies_data_format['per8'] = $row[110];
            $companies_data_format['f_collab9'] = $row[111];
            $companies_data_format['f_prod9'] = $row[112];
            $companies_data_format['nature9'] = $row[113];
            $companies_data_format['per9'] = $row[114];
            $companies_data_format['f_collab10'] = $row[115];
            $companies_data_format['f_prod10'] = $row[116];
            $companies_data_format['nature10'] = $row[117];
            $companies_data_format['per10'] = $row[118];
            $companies_data_format['member'] = $row[119];
            $companies_data_format['iso'] = $row[120];
            $companies_data_format['isodate'] = $row[121];
            $companies_data_format['isoagency'] = $row[122];
            $companies_data_format['qs'] = $row[123];
            $companies_data_format['qsdate'] = $row[124];
            $companies_data_format['qsagency'] = $row[125];
            $companies_data_format['iso14'] = $row[126];
            $companies_data_format['iso14date'] = $row[127];
            $companies_data_format['iso14agency'] = $row[128];
            $companies_data_format['ts'] = $row[129];
            $companies_data_format['tsdate'] = $row[130];
            $companies_data_format['tsagency'] = $row[131];
            $companies_data_format['deming_award'] = $row[132];
            $companies_data_format['japan_quality_medal'] = $row[133];
            $companies_data_format['emark'] = $row[134];
            $companies_data_format['bismark'] = $row[135];
