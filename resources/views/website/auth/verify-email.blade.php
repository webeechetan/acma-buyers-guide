                    ...
                    <div class="col-md-12">
                        <div class="card-body">
                            <div class="alert alert-success" role="alert">
                                ...
                                <p>Aww yeah, you successfully verified your email address. Now you can login to your account.</p>
                                <hr>
                                <p class="mb-0">If you didn't receive the email, <a href="{{ route('verification.resend') }}">click here to request another</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
